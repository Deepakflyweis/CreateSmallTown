              ...
              child: Row(
                ...
                children: [
                 ...
                 SizedBox(width: screenSize.width * 0.22,),
                  ...
                  Expanded(child: Icon(Icons.settings,size: 30,color: MyAppTheme.whiteColor,))
                ],
              ),
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.all(10),
                      child: Image.asset(
                        'assets/images/graph.png', fit: BoxFit.fill,),
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: Image.asset(
                            'assets/images/summary.png', fit: BoxFit.fitWidth,),
                        ),
                        Container(
                          height: 80,
                          width: 100,
                          child: Image.asset(
                            'assets/images/feedback.png', fit: BoxFit.fitWidth,),
                        ),
                      ],
                    ),
