...
class PermanentJob extends StatefulWidget {
  const PermanentJob({Key? key}) : super(key: key);

  @override
  _PermanentJobState createState() => _PermanentJobState();
}

class _PermanentJobState extends State<PermanentJob> {
  @override
          ...
          child: Column(
            children: [
              ...
              children: [
                ...
                Divider(height: 10,color: MyAppTheme.black_Color,thickness: 1,),
                ...
                Divider(height: 10,color: MyAppTheme.black_Color,thickness: 1,), SizedBox(
                  height: screenSize.height * 0.03,
                ),
                Row(
                  children: [
